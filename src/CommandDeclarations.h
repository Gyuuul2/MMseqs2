...
extern int lin8extractkmers(int argc, const char **argv, const Command& command);
extern int lin8assignedpairs(int argc, const char **argv, const Command& command);
extern int lin8pref(int argc, const char **argv, const Command& command);
extern int lin8align2clust(int argc, const char **argv, const Command& command);
extern int lin8align2clustmulti(int argc, const char **argv, const Command& command);
extern int lin8mergehashredundancy(int argc, const char **argv, const Command& command);
extern int lin8createclusterdb(int argc, const char **argv, const Command& command);
