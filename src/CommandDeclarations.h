...
extern int lin8createdb(int argc, const char **argv, const Command& command);
extern int linclustbatch(int argc, const char **argv, const Command& command);
extern int linclustbatchaws(int argc, const char **argv, const Command& command);
extern int clusterbatch(int argc, const char **argv, const Command& command);
extern int clusterbatchaws(int argc, const char **argv, const Command& command);
extern int linclustbatchworker(int argc, const char **argv, const Command& command);
extern int clusterbatchworker(int argc, const char **argv, const Command& command);
extern int batchclusteringprepare(int argc, const char **argv, const Command& command);
extern int batchclusteringmerge(int argc, const char **argv, const Command& command);
extern int lin8clusthash(int argc, const char **argv, const Command& command);
extern int lin8clust(int argc, const char **argv, const Command& command);
extern int lin8kmers(int argc, const char **argv, const Command& command);
extern int lin8pairs(int argc, const char **argv, const Command& command);
extern int lin8pref(int argc, const char **argv, const Command& command);
extern int lin8align(int argc, const char **argv, const Command& command);
extern int lin8cluster(int argc, const char **argv, const Command& command);
extern int lin8expand(int argc, const char **argv, const Command& command);
extern int lin8merge(int argc, const char **argv, const Command& command);
extern int lin8createtsv(int argc, const char **argv, const Command& command);
extern int lin8repseq(int argc, const char **argv, const Command& command);
