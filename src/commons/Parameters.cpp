...
Parameters::Parameters():
        ...
        PARAM_CREATEDB_MODE(PARAM_CREATEDB_MODE_ID, "--createdb-mode", "Createdb mode", "Createdb mode 0: copy data, 1: soft link data and write new index (works only with single line fasta/q) 2: GPU compatible db, 3: GPU compatible db sorted by descending length", typeid(int), (void *) &createdbMode, "^[0-3]{1}$"),
