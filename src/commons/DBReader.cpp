...
// Maps every data file, keeping a dup'd descriptor when the caller asked for cache advice: fadvise
// needs one, and it has to outlive the mapping because fadvise only works once the pages are unmapped.
