...
std::vector<Command> baseCommands = {
        ...
        {"lin8-align", lin8align, &par.lin8align, COMMAND_CLUSTER,
                "align2clust's aligning half: each representative against its candidates in the pref",
                "mmseqs lin8align sequenceDB pref clusters --threads 20\n",
                "Gyuri Kim <gyuribio@snu.ac.kr>",
                "<i:sequenceDB> <i:prefPairs> <o:clusters>",
                CITATION_MMSEQS2, {{"sequenceDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                                           {"prefPairs", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile },
                                                           {"clusters", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::flatfile }}},
        {"lin8-cluster", lin8cluster, &par.lin8cluster, COMMAND_CLUSTER,
                "align2clust's clustering half: each sequence to the first representative that reached it",
                "mmseqs lin8cluster aligned clusters\n",
                "Gyuri Kim <gyuribio@snu.ac.kr>",
                "<i:alignedPairs> <o:clusters>",
                CITATION_MMSEQS2, {{"alignedPairs", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile },
                                                           {"clusters", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::flatfile }}},
        {"lin8-expand", lin8expand, &par.lin8expand, COMMAND_CLUSTER,
                "mergeclusters's first half: the sequences the redundancy pass folded away, put back",
                "mmseqs lin8expand decided hash expanded\n",
                "Gyuri Kim <gyuribio@snu.ac.kr>",
                "<i:decidedPairs> <i:redundancyPairs> <o:decidedPairs>",
                CITATION_MMSEQS2, {{"decidedPairs", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile },
